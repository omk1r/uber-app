...
const RidePopup = () => {
  return (
    <>
      ...
      <div className="flex flex-col justify-between items-center gap-2 my-1">
        ...
        <button className="bg-green-600 mt-1 p-2 rounded-lg w-full font-semibold text-white">
          Confirm
        </button>
        <button className="bg-gray-300 mt-1 p-2 rounded-lg w-full font-semibold text-gray-700">
          Ignore
        </button>
      </div>
    </>
